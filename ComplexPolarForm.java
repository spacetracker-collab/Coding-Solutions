public class ComplexPolarForm {
    ...
    public static void main(String[] args) {
        ...
        //Real part>0
        ComplexNumber complexRectangular = new ComplexNumber(10,3);
        double[] polarCoardinates = complexRectangular.toPolar(complexRectangular);
        System.out.println(polarCoardinates[0]+" (cos("+polarCoardinates[1]+") +i sin("+polarCoardinates[1]+"))");
...
class ComplexNumber {
    ...
    public double[] toPolar(ComplexNumber c) {
